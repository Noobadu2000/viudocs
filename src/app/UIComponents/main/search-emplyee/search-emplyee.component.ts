    ...
    if (this.searchForm.valid) {
      ...
      if (isUserInList) {
        if (this.verifiedUsers !== undefined) {
          isUserInVerification = _.find(this.verifiedUsers, (ele: any) => { return ele.Name == SearchData.email });
         ...
         else if (_.isUndefined(isUserInVerification)) {
        ...
        window.alert('User not in the database');
      }
